<?php 
    ...
    $row = mysqli_fetch_array($result);
       ...
       $outputDisplay  = "<br/><span style = 'text-align:center'><h4><a href = 'student.php'>Quit Filter...</a></h4><h1>Students In: " . $school . " </h1></span>";
	...
	elseif ($school_id_teacher != "") {
		
	$query  = "SELECT * FROM `school` WHERE school_id = '$school_id_teacher' ";
    $result = mysqli_query($db, $query);
    $row = mysqli_fetch_assoc($result);
	...
	$sql_statement  = "SELECT * ";
    $sql_statement .= "FROM teacher WHERE posted_school_id = '$school_id_teacher' ";
    ...
    $outputDisplay = "";
        ...
        $outputDisplay  = "<br/><span style = 'text-align:center'><h4><a href = 'teacher.php'>Quit Filter...</a></h4><h1>Teachers In: " . $school_name . "</h1>";
