...
<head>
<meta charset="utf-8">
<title>No. Of Incidents Handled By Teacher</title>
...
<form method = "post" action="" >
  ...
  <div style = 'background-color: lightblue; width:100%; hieght:30px'><h1 style='text-align:center'>NO. OF INCIDENTS HANDLED BY SPECIFIC TEACHER REPORT</h1></div>
 

<h4 style = "color:black ; margin-left:20px"> Choose School:
        <select id = 'school-list' name = 'school' onChange="getTeacher(this.value);" required>
...
<?php
	...
	?>
	   ...
	   <h4 style = "color:black; margin-left:40px"> Enter Teacher ID:
