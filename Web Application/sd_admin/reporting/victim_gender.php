...
<head>
<meta charset="utf-8">
<title>Victims of Bullying (Gender Based Report) Report</title>
...
function showInfo(str) {
		...
		xmlhttp.open("GET","victim_info.php?q="+str+"&y="+grade+"&z="+sch,true);
        xmlhttp.send();
    }
}
</script>
...
<form method = "post" action="" >
  ...
  <div style = 'background-color: lightblue; width:100%; hieght:30px'><h1 style='text-align:center'>VICTIMS OF BULLYING (GENDER BASED) REPORT</h1></div>
 
    

    <h4 style = "color:black;margin-left:20px"> Choose Victim School:
...
<?php
  ...
  <h4 style = "color:black;margin-left:40PX"> Choose Victim Grade:
        <select id = 'grade-list' name = 'grade' onChange="getGender(this.value);" required>
          <option value="">---</option>
	
        </select>
      </h4>
   <h4 style = "color:black;margin-left:60PX"> Choose Victim Gender:
