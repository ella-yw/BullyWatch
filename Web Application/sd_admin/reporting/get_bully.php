...
error_reporting(0);
session_start();
$location = $_SESSION['login_status_location_school_admin'];$query = "SELECT DISTINCT bully_id, bully_fname, bully_lname
FROM `un_incident_reporting_bully` 
WHERE bully_school_id = " . $_POST["school"] . " AND bully_grade = " . $_POST["grade"];
