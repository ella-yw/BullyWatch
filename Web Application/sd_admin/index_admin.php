...
<meta charset="utf-8">
<link rel="stylesheet" href="../css/style_sd_admin.css">
...
<h1 style = "color:white; text-align:center; margin-top:10%">Welcome <?php 
...
echo $row['admin_lname'] . ", " . $row['admin_fname']; ?></h1><h5 style = "color:white; text-align:center; margin-bottom:4%">Administrator Of School District <?php $query = "SELECT * FROM `sd` WHERE sd = ".$location.""; 
$results = mysqli_query($db, $query); 
$row = mysqli_fetch_assoc($results);  echo $row['sd'] ?></h5>
