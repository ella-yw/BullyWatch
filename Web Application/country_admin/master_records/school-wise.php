<?php 
    ...
    $row = mysqli_fetch_array($result);
       ...
       $outputDisplay  = "<br/><h4><a href = 'student.php'>Quit Filter...</a></h4><h1>Students In: " . $school . " </h1>";
    ...
    $outputDisplay = "";
        ...
        $outputDisplay  = "<br/><h4><a href = 'teacher.php'>Quit Filter...</a></h4><h1>Teachers In: " . $school_name . "</h1>";
