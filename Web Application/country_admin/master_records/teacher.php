...
<div style = "width:100%; margin:0 auto;">	
  ...
  if (isset($_POST['limit']))
  {
    ...
    $sql_statement .= "FROM teacher JOIN school ON (posted_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN province USING (province_id) WHERE country_id= '$location' ";
    ...
    $outputDisplay = "";
        ...
        $outputDisplay  = "<br/><h1>Teachers In: " . $country_name . "</h1>";
