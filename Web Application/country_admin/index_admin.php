...
<meta charset="utf-8">
<link rel="stylesheet" href="../css/style_country_admin.css">
...
echo $row['admin_lname'] . ", " . $row['admin_fname']; ?></h1><h5 style = "color:white; text-align:center; margin-bottom:4%">Administrator Of <?php $query = "SELECT * FROM `country` WHERE country_id = '".$location."'"; 
$results = mysqli_query($db, $query); 
$row = mysqli_fetch_assoc($results);  echo $row['country_name'] ?></h5>
