		...
		<br/><br/><br/><br/><br/><br/>
			 ...
			 <form>
               ...
               <select id = 'all_tables' class = "select" size="4">
                ...
                <option value = 'types_per_province.php'>Province-Wise Bullying Type Ratio </option>
                <option value = 'main_sd_incident.php'>SD-Wise Incident Ratio & Comparison </option>
                <option value = 'fake_complaints.php'>Province-Wise Fake Complaints</option>
