...
<form method = "post" action="" >
  ...
  <div style = 'background-color: lightblue; width:100%; hieght:30px'><h1 style='text-align:center'>BULLY GENDER-BASED BULLYING TYPE REPORT</h1></div>
...
WHERE province_id = '".$location."' AND bully_gender = '$gender'"; 
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."' AND incident_reporting.bullying_type = 'General Verbal Insults' AND bully_gender = '$gender'";
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."' AND incident_reporting.bullying_type = 'General Beatings/Pushing' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."' AND incident_reporting.bullying_type = 'Terrorizing/Threatening Remarks' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
AND incident_reporting.bullying_type = 'False Gossip Inflation (Rumors)' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Discrimination' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	 
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Rough Fighting' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	 
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Sexual Utterance/Assaults' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	 
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'General Exclusion' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	 
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Theft' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	 
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Racist Utterance/Assaults' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Personal Property Damage'  AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);	
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Internet Related (Cyber)' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);		
...
FROM incident_reporting JOIN `un_incident_reporting_bully` USING(report_id) JOIN school ON (bully_school_id=school_id) JOIN sd ON (school.sd=sd.sd) JOIN city ON (city_id=city_name) JOIN `province` USING(province_id)
WHERE province_id = '".$location."'
AND incident_reporting.bullying_type = 'Other/Unspecified' AND bully_gender = '$gender'";
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);			
...
"legend":{
	...
	"title": {
  "text":"Showing Bully Results For: <?php echo $province; ?> (<?php echo $gender; ?>)",
  "color":"green"
  
},
"subtitle": {
  "text":"Total <?php echo $gender; ?> Bullies Reported: <?php echo $row_cnt; ?>",
  "color":"blue"
}, 
        "series":[
                {
