...
function showInfo(str) {
		...
		xmlhttp.open("GET","victim_info.php?q="+str+"&y="+grade,true);
        xmlhttp.send();
    }
}
</script>
...
<form method = "post" action="" >
  ...
  <h4 style = "color:black;margin-left:20PX"> Choose Victim Grade:
   ...
   <h4 style = "color:black;margin-left:40PX"> Choose Victim Gender:
