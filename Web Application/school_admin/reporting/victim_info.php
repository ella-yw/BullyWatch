    ...
    //**********************************************
	   ...
	   session_start();
		...
		?>
			<div style='float:left; margin-left:20px'><h3 style = 'color:blue'><a onclick="<?php session_start(); $_SESSION['school_id_for_pdf'] = $location; $_SESSION['grade_for_pdf'] = $grade; $_SESSION['gender_for_pdf'] = $gender; ?>" href = "victim_gender_pdf.php" >SAVE TO PDF</a></h3></div>
			<br/><br/><?php
