...
<head>
<meta charset="utf-8">
<title>Grade-Wise Victim Ratio</title>
...
<form method = "post" action="" >
  ...
  <div style = 'background-color: lightblue; width:100%; hieght:30px'><h1 style='text-align:center'>GRADE-WISE VICTIM RATIO</h1></div>
 ...
 $query = "SELECT DISTINCT incident_reporting.victim_id FROM incident_reporting JOIN un_incident_reporting_victim USING (report_id) WHERE victim_school_id=$location";
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '1' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '2' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '3' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '4' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
	array_push($pieChart, $row[0]);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '5' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '6' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '7' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '8' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '9' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '10' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '11' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
$query = "SELECT COUNT( * )
FROM incident_reporting JOIN `un_incident_reporting_victim` USING(report_id)
WHERE un_incident_reporting_victim.victim_grade = '12' AND un_incident_reporting_victim.victim_school_id = ".$location;
	$result = mysqli_query($db, $query); 
    $row = mysqli_fetch_row($result);
...
"subtitle": {
  "text":"Total Distinct Victim(s) At School: <?php echo $row_cnt; ?>",
  "color":"blue"
},
            "type":"bar", 
        "series":[
