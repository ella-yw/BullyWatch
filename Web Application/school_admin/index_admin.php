...
<meta charset="utf-8">
<link rel="stylesheet" href="../css/style_school_admin.css">
...
$location =  $_SESSION['login_status_location_school_admin'];
   $query = "SELECT * FROM `admin` WHERE location = ".$location.""; 
								  ...
								  echo $row['admin_lname'] . ", " . $row['admin_fname']; ?></h1><h5 style = "color:white; text-align:center; margin-bottom:4%">Administrator Of <?php $query = "SELECT * FROM `school` WHERE school_id = ".$location.""; 
								  $results = mysqli_query($db, $query); 
								  $row = mysqli_fetch_assoc($results);  echo $row['school_name'] ?></h5>
...
<div class="container">
      <div class="row" >
        <div class="grid_4" style = "margin-bottom:3%">
          ...
          <a href = "assign_incident/assign_incident.php" style = "background-color:#025cf6" class="banner"><div>
            <div class="fa fa-file-text-o"></div><strong>Assign<br/>An Incident</strong></div>
          </a>
