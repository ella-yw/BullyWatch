...
$message = "<span style = 'font-size:15px'>Dear " . $row['admin_lname'] . ", " . $row['admin_fname'] . ", <br/><br/>You have recently intended to change your password.<br/><br/><b> Enter this code in your school admin's home page: $random_password</b><br/>(This code should only be valid for 30 minutes)<br/><br/>Login address: http://stopbeingbullied.org/school_admin/index_admin.php <br/><br/>Sincerely,<br/>Stop Being Bullied</span>";
$to = $row['admin_email'];
