 ...
 jQuery(function($){ // 9 = [0-9], a = [a-z A-Z], * = [a-z A-Z 0-9]
   ...
   $(".phn").mask("9999 999 999");
    ...
    function deletealert(student_id, student_lname, student_fname) {
		...
		document.getElementById("del").innerHTML = "<br/><br/><b><div style='text-align:center'><mark>Student: "+student_lname+", "+student_fname+" ("+student_id+") has been successfully deleted!</mark></div></b><br/>";
	...
	<form method = "post" action="" enctype="multipart/form-data">
        <div class = "head">
         ...
         <h4 style = "color:black; margin-left:10px">        
        	<label>Overall Results For:</label>
					...
					<?php
					$result = mysqli_query($db,"SELECT * FROM school WHERE school_id = '$location'");
       ...
       <h2 style = "color:black; margin-left:20px">        
        	...
        	<label>Grade:&nbsp;&nbsp;&nbsp;&nbsp;</label>
				...
				<option value="" selected="true" disabled="disabled">Select Grade...</option>
...
<div style = "margin:0 auto; width:100%;text-align:center;">	
    ...
    -		$student_fname = trim($_POST['student_fname']);
		...
		$sql_statement .= "WHERE school_id = ".$location." ";
    ...
    <div id='update_student' style = "margin:0 auto; width:50%;text-align:center;">
        ...
        <b id = "note">*Note: You cannot change the Student ID (Primary Key)!</b>
       ...
       <p>New Parent Contact:<br>
		...
		{
			$outputDisplay  = " <input type = 'text' name = 'school_id' value = '".$row['school_id']."' disabled = 'disabled'/>";
   ...
   <?php
    ...
    <div id='add_student' style = "margin:0 auto; width:50%;text-align:center;">
       ...
       <p>Enter Parent Contact:<br>
		...
		{
			$outputDisplay  = " <input type = 'text' name = 'school_id_add' value = '".$row['school_id']."' disabled = 'disabled'/>";
        ...
        <br><span><input id = "submit" type="submit" name="addbutton" value="Add Student" /></span><br/><br/><br><br><br><br><br>
   </form>
...
<div id = "display_table" style = "margin:0 auto; width:100%;text-align:center;">
   ...
   <form  method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
    <div style = "color:blue" >
       <b><br><br><input id = "limit" type="submit" name="limit" value="Show: " /> &nbsp;&nbsp;
  ...
  if (isset($_POST['limit']))
  {
	...
	$sql_statement  = "SELECT * ";
    $sql_statement .= "FROM student WHERE school_id = $location ";
    ...
    if (!$result) {
       ...
       $outputDisplay  = "<br/><h1>Student Table Data</h1>";
        ...
        $outputDisplay .= '<table style="color: black;text-align:center;margin: 0 auto">';
        $outputDisplay .= '<tr>
		<th>  Delete? &nbsp; </th>
		<th>  ID &nbsp; </th>
		<th>  Last Name &nbsp; </th>
