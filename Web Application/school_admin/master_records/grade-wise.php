<?php 
    ...
    $row = mysqli_fetch_array($result);
       ...
       $outputDisplay  = "<br/><span style = 'text-align:center'><h4><a href = 'student.php'>Quit Filter...</a></h4><h1>Students In Grade: " . $grade . " ($school_name)</h1></span>";
    ...
    $row = mysqli_fetch_array($result);
       ...
       $outputDisplay  = "<br/><span style = 'text-align:center'><h4><a href = 'teacher.php'>Quit Filter...</a></h4><h1>Teachers In Grade: " . $grade_teacher . " ($school_name_teacher)</h1>";
